...
1․ Download the [LaraDumps Desktop App](get-started/installation?#desktop-app).

2․ Add the [LaraDumps Laravel Package](get-started/installation?#laravel-package) to your Laravel project.
